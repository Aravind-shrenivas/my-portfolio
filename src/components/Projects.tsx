  ...
  const projects = [
    {
      ...
      demoUrl: "https://huggingface.co/spaces/aravind/diabetic-foot-segmentation",
      icon: "🏥"
    },
    {
      ...
      demoUrl: "https://churn-demo.azurewebsites.net",
      icon: "📊"
    },
    {
      ...
      demoUrl: "https://claims-dashboard.herokuapp.com",
      icon: "⚡"
    }
  ];
              ...
              <div className="p-8">
                ...
                <div className="flex space-x-3">
                  <a 
                    ...
                    className="flex-1 bg-gradient-to-r from-gray-800 to-gray-900 dark:from-gray-200 dark:to-gray-100 text-white dark:text-black text-center py-3 rounded-xl hover:shadow-lg font-semibold transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
                  >
                    <Github size={16} />
                    GitHub
                  </a>
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 bg-gradient-to-r from-blue-600 to-emerald-600 text-white text-center py-3 rounded-xl hover:shadow-lg font-semibold transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
                  >
